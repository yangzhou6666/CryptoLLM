...
from transformers import get_linear_schedule_with_warmup, RobertaConfig, ElectraTokenizer, ElectraForSequenceClassification
...
class EarlyStopping(object):
    def __init__(self, patience=3, args=None):
        ...
        checkpoint_prefix = f'electra.bin'
...
def main():
    ...
    encoder = ElectraForSequenceClassification.from_pretrained(args.model_path, config=config)    

    model = ELECTRA(encoder, config, tokenizer, args)
